...
Provenance public, không chứa dữ liệu runtime:

```bash
curl -fsS http://127.0.0.1:8000/api/provenance
curl -fsSI http://127.0.0.1:8000/api/health | grep -i x-novelkit-provenance
```
